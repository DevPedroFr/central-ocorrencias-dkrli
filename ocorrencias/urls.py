...
urlpatterns = [
    ...
    path('observacoes-noc/', views.observacoes_noc, name='observacoes_noc'),
    path('observacoes-noc/<slug:slug>/', views.observacoes_cliente, name='observacoes_cliente'),
    path('observacoes-noc/<slug:slug>/nova/', views.nova_observacao_cliente, name='nova_observacao_cliente'),
    path('observacoes-noc/obs/<int:pk>/deletar/', views.deletar_observacao_cliente, name='deletar_observacao_cliente'),
